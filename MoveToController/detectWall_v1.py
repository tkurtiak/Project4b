...
def PoseEstimate(leftImg,rightImg):
    ...
    for iterable in range(0,rolavnum):
        ...
        keypoints = cPickle.loads(open("/home/qdmc/bebop_ws/src/dqmc/MoveToController/keypoints.txt").read())
        kp = []
        ...
        des_img_des = np.loadtxt('/home/qdmc/bebop_ws/src/dqmc/MoveToController/descriptors.txt', dtype = float)
        a = des_img_des
